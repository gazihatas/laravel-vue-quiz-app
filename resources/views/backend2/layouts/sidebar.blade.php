...
<div class="page-body-wrapper sidebar-icon">
    ...
    <header class="main-nav">
        ...
        <div class="sidebar-user text-center">
            ...
            <img class="img-90 rounded-circle" src="{{asset('admin/admin/../assets/images/dashboard/1.png')}}" alt="">

            <div class="badge-bottom">
                <span class="badge badge-primary">New</span></div>
            ...
            <div class="main-navbar">
                ...
                <div id="mainnav">
                    <ul class="nav-menu custom-scrollbar">
                        ...
                        <li class="dropdown"><a class="nav-link menu-title link-nav" href="{{url('/')}}"><i data-feather="home"></i><span>Anasayfa</span></a>
                        </li>
                        <!--
                        ...
                        <!-- ##################### Sınav Yönetimi Başlangıç  ####################################### -->
                        <!-- Sınav Yönetimi Ana başlık-->
                        <li class="sidebar-main-title">
                            <div>
                                <h6>Sınav Yönetimi            </h6>
                            </div>
                        </li>

                        <!-- Sınav Yöntimi-> Sınav  -->
                        <li class="dropdown"><a class="nav-link menu-title" href="javascript:void(0)"><i data-feather="box"></i><span>Sınav</span></a>
                            <ul class="nav-submenu menu-content">
                        ...
                        <!-- Sınav Yöntimi-> Soru -->
                        <li class="dropdown"><a class="nav-link menu-title" href="javascript:void(0)"><i data-feather="folder-plus"></i><span>Soru</span></a>
                            <ul class="nav-submenu menu-content">
                        ...
                        <!-- Sınav Yöntimi-> Kullanıcı  -->
                        <li class="dropdown"><a class="nav-link menu-title" href="javascript:void(0)"><i data-feather="user"></i><span>Kullanıcı</span></a>
                            <ul class="nav-submenu menu-content">
                        ...
                        <!-- Sınav Yöntimi-> Sınav Yönetimi  -->
                        <li class="dropdown"><a class="nav-link menu-title" href="javascript:void(0)"><i data-feather="cloud-drizzle"></i><span>Sınav Yönetimi</span></a>
                            <ul class="nav-submenu menu-content">
                        ...
                        <li>
                            <a class="nav-link menu-title link-nav" href="{{ route('logout') }}"  onclick="event.preventDefault();
                                                     document.getElementById('logout-form').submit();">
