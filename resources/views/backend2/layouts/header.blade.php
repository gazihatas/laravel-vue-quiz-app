...
<head>
    ...
    <!-- Plugins css start-->
    <link rel="stylesheet" type="text/css" href="{{asset('admin/admin/../assets/css/animate.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('admin/admin/../assets/css/chartist.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('admin/admin/../assets/css/date-picker.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('admin/admin/../assets/css/prism.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('admin/admin/../assets/css/vector-map.css')}}">
    <!-- Plugins css Ends-->
    <!-- Bootstrap css-->
